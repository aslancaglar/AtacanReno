...
const Header = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50">
      ...
      {megaOpen && (
        <div className="hidden xl:block absolute left-0 right-0 top-full z-50" onMouseEnter={handleMegaEnter} onMouseLeave={handleMegaLeave}>
      ...
      {mobileOpen && (
        <div className="xl:hidden mx-4 mt-2 bg-card/95 backdrop-blur-xl rounded-2xl shadow-lg">
