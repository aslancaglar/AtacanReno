...
const HeroSection = () => {
  ...
  return (
    <section id="hero" className="relative min-h-[85vh] md:min-h-[60vh] lg:min-h-[90vh] flex items-center overflow-hidden">
      ...
      <div className="relative container mx-auto px-4 lg:px-8 pb-32 sm:pb-24 lg:pb-24 pt-40 sm:pt-24 lg:pt-32">
